        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BuildingNumber = table.Column<string>(type: "varchar(30)", maxLength: 30, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("checkValidEmail", "Email like '_%@_%._%'");
                    table.CheckConstraint("checkValidPhone", "Phone like '01%' And Phone Not like '%[^0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("checkDurationDaysLimit", "DurationDays between 1 And 365");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("checkValidEmail1", "Email like '_%@_%._%'");
                    table.CheckConstraint("checkValidPhone1", "Phone like '01%' And Phone Not like '%[^0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    tarainerID = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("checkCpacity", "Capacity between 1 and 25");
                    table.CheckConstraint("checkSsessionDate", "EndDate > StartDate");
                    table.ForeignKey(
